...
public class LeaderSelectorPrey : MonoBehaviour
{
    ...
    private int selectLeader(List<Dictionary<String, FuzzySet>> results)
    {
        ...
        for (int i = 0; i < results.Count; i++)
        {
            ...
            if (curResults["defensa"].name().Equals("alto") && curResults["comunicacion"].Equals("alto") &&
        ...
        {
            Dictionary<String, FuzzySet> curResults = results[i];
            if (curResults["resistencia"].name().Equals("medio") ||
                curResults["resistencia"].name().Equals("alto") && curResults["velocidad"].Equals("alto")) return i;
        }
        ...
        {
            Dictionary<String, FuzzySet> curResults = results[i];
            if (curResults["defensa"].name().Equals("medio") && curResults["salud"].Equals("alto") &&
                curResults["edad"].Equals("2.00")) return i;
        }
        return 0;
    }
